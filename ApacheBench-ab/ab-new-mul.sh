...
do
let tmp="${thread}*${req_num}"
echo $tmp
rm ./data/ab_init_${req_num}_${thread}.log
./ab -k -c $thread -n $tmp http://10.176.22.211/VOD4K/Test_track11.15.mp4 >> ./data/ab_init_${req_num}_${thread}.log
